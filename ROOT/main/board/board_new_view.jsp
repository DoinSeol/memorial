...
sql = sql + "where blevel = 0 and seqid > " + rq_idx + " and bref != " + rs_bref + " ";
        ...
        <tr>
          <td width="100%" align="center" valign="top">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td width="16%" align="center" bgcolor="#f6f8fc"><font color="#003f85"><strong>제 목</strong></font></td>
                  <td height="3"  align="center" valign="top"><img src="board/images/line.gif" alt=""></td>
                ...
                <tr>
                  <td width="100%" height="300" align="center" valign="top" colspan="6">
                      <table width="100%" border="0" cellspacing="0" cellpadding="15">
                        
                        <tr><td width="100%" align="left" valign="top"><p style="line-height: 1.6em;"><%=rs_bcontent%></p></td></tr>
