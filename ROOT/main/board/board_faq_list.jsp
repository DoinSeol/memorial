...
String[] b_search_type_array = {"질문", "답변", "작성자"};
...
function faq_show(num){
  var submenu = document.getElementById("ans_wqrp_" + num)
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <!--tr>
                  <td width="50%" height="20" align="left">
                   ...
                   <td width="50%" height="20" align="right">
                      ...
                      <input type="text" name="sk" size="15" id="sk" maxlength="15" value="<%=rq_search_key%>">
                      <input type="image" src="board/images/button_search.gif" width="50" height="20" border="0" align="absmiddle" alt="검색"></a>
                  </td>
                </tr-->
        ...
        <tr>
          <td width="100%">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="15%" height="3" bgcolor="#e0144c"></td>
                  <td width="85%" height="3" colspan="10" bgcolor="#005bb0"></td>
                </tr>
              </table>
          </td>
        </tr>
        <tr>
          <td width="100%">
              ...
              <thead>
                ...
                <tr>
                  <th width="15%"  height="28" style="text-align:center" scope="col"><font color="#003f85"><strong>번호</strong></font></th>
                  <td height="28" align="center"><img src="board/images/line.gif" width="1" height="28" alt=""></td>
                  <th width="85%" height="28" style="text-align:center" scope="col"><font color="#003f85"><strong>질문</strong></font></th>
                  <!--td height="28" align="center"><img src="board/images/line.gif" width="1" height="28" alt=""></td>
                ...
                <tr><td width="100%" height="1" colspan="3" bgcolor="#BBBBBB"></td></tr>
                ...
                if(record_count > 0)
                {
                  ...
                  while(rs_list.next())
                  {
                    ...
                    //rs_bsubject = "<a href='#aa' onclick='faq_show("+i+"); return false;'>" + rs_bsubject + "</a>";
                    ...
                    out.println("<tr><td width='100%' colspan='3' height='1 background='board/images/dot_line_p.gif' alt=''></td></tr>");
                    
                    out.println("<tr id='ans_wqrp_"+i+"' style='display: none;'>");
                    out.println("  <td align='center'>&nbsp;</td>");
                    out.println("  <td align='center'>&nbsp;</td>");
                    out.println("  <td align='left' colspan='3' bgcolor='#eeeeee'>" + rs_bcontent + "</td>");
                    out.println("</tr>");
                    
                    i++;
                    
                    out.println("<tr><td width='100%' height='1' colspan='3' background='board/images/dot_line_p.gif' alt=''></td></tr>");
                ...
                {
                  out.println("<tr><td width='100%' height='200' colspan='3' align='center'>등록된 내용이 없습니다.</td></tr>");
                }                %>
                
                <tr><td width="100%" height="5" colspan="3"></td></tr>
                <tr><td width="100%" height="2" colspan="3" bgcolor="#005bb0"></td></tr>
                ...
                <tr>
                  ...
                  <td width="60%" height="30" align="center">
                      ...
                      if(curPage > intNumOfPage)
                      {
                        ...
                        out.println("<a href='program.action?" + req_unify_str + "&method=l&idx=&page=1'><img src='board/images/a_ic_ppre.gif' border='0' width='20' height='13' align='absmiddle' alt='처움페이지'></a>");
                      ...
                      {
                        out.println("<img src='board/images/a_ic_ppre.gif' border='0' width='20' height='13' align='absmiddle' alt='처움페이지'>");
